...
6) Bringing the Year from file name to the content : - parse the field that filename  ( 1- remove the letters this will leave year. 2) split the field and it will leave year in one field...)
